...
import * as posedetection from '@tensorflow-models/pose-detection';
 ...
 export class Camera {
    ...
    */
   static async setupCamera(cameraParam, videoElement, canvasElement, canvasWrapElement) {
    ...
    if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
     ...
     this.video = camera.video = videoElement;
     this.canvas = camera.canvas = canvasElement;
     this.ctx = camera.ctx = canvasElement.getContext("2d");
     ...
     const canvasContainer = canvasWrapElement;
  ...
  //   camera.scatterGLEl.style =
   ...
   //      params.STATE.modelConfig.render3D ? 'inline-block' : 'none';
     ...
     console.log("Done setting camera! " );
